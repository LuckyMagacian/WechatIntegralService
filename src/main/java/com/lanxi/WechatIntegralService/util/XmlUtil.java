...
public class XmlUtil {
	...
	/**
	 * �?单处�?(不�?�虑map list collection 等复杂情�?)
	 * bean转xml
	 * @param obj
	 * @return
	 */
	...
	public  static  Element easyToElement(Object obj,String rootName){
		try {
			...
			throw new AppException("通过bean创建Element时异�?",e);
		}
	}
	...
	public static DOMElement toElement(Object obj,String name){
		...
		//设置节点名称, 指定名称优先级最�?,对象中NAME字段内容其次,�?后使用类名简�?
		try{
		...
		return element;
			...
			throw new AppException("Object转Element时异�?",e);
		}
	}
	/**
	...
	public static DOMElement toElement(Map<String,Object> map,DOMElement parent){
		if(parent==null)
			throw new AppException("Map转Element�?,父节点为null");
		try{
	...
	public static DOMElement toElement(Collection<Object> collection,DOMElement parent){
		if(parent==null)
			throw new AppException("Collection转Element�?,父节点为null");
		try{
